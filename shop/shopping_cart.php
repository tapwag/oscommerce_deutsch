...
<?php
 ...
 // osc-support-edition BOF    
      if($products[$i]['baseprice'] > '0'){
         $baseprice = '<br />' . sprintf(TEXT_BASE_PRICE, $currencies->format($products[$i]['baseprice']), $products[$i]['baseprice_unit']);
      }else{
         $baseprice = '';
      }
...
// osc-support-edition BOF
           '        <td align="right" valign="top"><strong>' . $currencies->display_price_normal($products[$i]['final_price'], tep_get_tax_rate($products[$i]['tax_class_id']), $products[$i]['quantity']) . '</strong>' . $baseprice . '</td>' .
// osc-support-edition EOF
           '      </tr>';
    }
/*
...
?>
    ...
    <p align="right"><?php echo SUB_TITLE_SUB_NETTO; ?> <strong><?php echo $currencies->format($cart->show_netto()); ?></strong></p>
    <p align="right"><?php echo SUB_TITLE_SUB_NETTO_AMOUNT; ?> <strong><?php echo $currencies->format($cart->show_total() - $cart->show_netto()); ?></strong></p>
    <p align="right"><?php echo SUB_TITLE_SUB_TOTAL; ?> <strong><?php echo $currencies->format($cart->show_total()); ?></strong></p>
