...
insert into configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) values ('1', 'Store Name', 'STORE_NAME', 'osCommerce Teststore', 'The name of my store', '1', '1', '2015-02-24 12:25:51', '2015-02-23 09:52:38', NULL, NULL);
insert into configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) values ('2', 'Store Owner', 'STORE_OWNER', 'Mr. Store Owner', 'The name of my store owner', '1', '2', '2015-02-24 12:25:59', '2015-02-23 09:52:38', NULL, NULL);
insert into configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) values ('3', 'E-Mail Address', 'STORE_OWNER_EMAIL_ADDRESS', 'random@localhost', 'The e-mail address of my store owner', '1', '3', '2015-02-24 12:26:14', '2015-02-23 09:52:38', NULL, NULL);
insert into configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) values ('4', 'E-Mail From', 'EMAIL_FROM', 'hess@localhost', 'The e-mail address used in (sent) e-mails', '1', '4', '2015-02-24 12:26:32', '2015-02-23 09:52:38', NULL, NULL);
...
insert into configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) values ('15', 'Store Address and Phone', 'STORE_NAME_ADDRESS', 'osCommerce Teststore
Strasse
PLZ Ort
Land
...
insert into configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) values ('552', 'Logo', 'EDIT_INVOICE_LOGO', 'oscommerce.jpg', 'Hier können Sie ein Logo angeben, welches auf der Rechnung angezeigt werden soll', '787', '1', '2015-03-22 20:31:47', '0000-00-00 00:00:00', '', '');
...
insert into edit_invoice (edit_invoice_id, language_id, edit_invoice_text) values ('1', '1', 'Erster deutscher Text auf Rechnung');
insert into edit_invoice (edit_invoice_id, language_id, edit_invoice_text) values ('1', '2', 'First English text on invoice');
insert into edit_invoice (edit_invoice_id, language_id, edit_invoice_text) values ('2', '2', 'Second English text on invoice');
insert into edit_invoice (edit_invoice_id, language_id, edit_invoice_text) values ('2', '1', 'Zweiter deutscher Texte auf Rechnung');
...
insert into pages_description (id, pages_id, pages_title, pages_html_text, intorext, externallink, link_target, language_id) values ('15', '10', 'Kontaktformular', '', '1', 'contact_us.php', '0', '1');
insert into pages_description (id, pages_id, pages_title, pages_html_text, intorext, externallink, link_target, language_id) values ('16', '10', 'Contact Us', '', '1', 'contact_us.php', '0', '2');
...
Length: (approx) 115 minutes.<br />
Other: Interactive Menus, Chapter Selection, Subtitles (more languages).', '', '0');
insert into products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) values ('16', '1', 'Mut zur Wahrheit', 'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br />
Languages: English, Deutsch.<br />
Subtitles: English, Deutsch, Spanish.<br />
Audio: Dolby Surround 5.1.<br />
Picture Format: 16:9 Wide-Screen.<br />
