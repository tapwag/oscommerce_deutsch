...
<ul>
<li>Sie k&ouml;nnen bei uns per &Uuml;berweisung oder bezahlen.</li>
</ul>
</div>
...
insert into pages_description (id, pages_id, pages_title, pages_html_text, intorext, externallink, link_target, language_id) values ('21', '13', 'AGB´s', '<p>Diese allgemeinen Verkaufs-und Lieferbedingungen gelten f&uuml;r alle Kaufvertr&auml;ge, die mit dem Shop Web Shop, XXX einbezogen sind. Mit der Bestellung erkl&auml;ren Sie sich mit diesen Bedingungen. <br> <br> Siehe den Volltext auf Deutsch oder Englisch, indem Sie auf der Landesflagge in der rechten Spalte klicken. Sie k&ouml;nnen dann wieder auf Ihre Sprache, indem Sie die Flagge Ihres Landes anklicken.</p>', '1', 'conditions.php', '0', '2');
...
insert into products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) values ('29', '1', 'Bärendienst', '<p>DDD</p>', '', '0');
