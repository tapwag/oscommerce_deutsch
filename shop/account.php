...
<div class="contentContainer">
  ...
  <div class="contentText">
    <ul class="accountLinkList">
      ...
      <li><span class="ui-icon ui-icon-delete accountLinkListEntry"></span><?php echo '<a href="' . tep_href_link(FILENAME_ACCOUNT_DELETE, '', 'SSL') . '">' . MY_ACCOUNT_DELETE . '</a>'; ?></li>
    </ul>
  </div>
...
<h2><?php echo CONTACT_WITHDRAWL_TITLE; ?></h2>

  <div class="contentText">
    <ul class="accountLinkList">
      <li><span class="ui-icon ui-icon-mail-closed accountLinkListEntry"></span><?php echo '<a href="' . tep_href_link(FILENAME_WIDERRUF_FORM, '', 'SSL') . '">' . EMAIL_WIDERRUF . '</a>'; ?></li>
      <li><span class="ui-icon ui-icon-mail-closed accountLinkListEntry"></span><?php echo '<a href="' . tep_href_link(FILENAME_CONTACT_US, '', 'SSL') . '">' . EMAIL_CONTACT_US . '</a>'; ?></li>
    </ul>
  </div>
