...
// EU-NEUE BOF
              '    <a href="' . tep_href_link(FILENAME_SHIPPING) . '">'                       . MODULE_BOXES_INFORMATION_BOX_SHIPPING    . '</a><br>' .
              '    <a href="' . tep_href_link(FILENAME_WIDERRUF_FORM) . '">'                       . MODULE_BOXES_INFORMATION_BOX_WIDERRUF_FORM    . '</a><br>' .
// EU-NEUE EOF
...
// osc-support-edition BOF              
              '    <a href="' . tep_href_link(FILENAME_IMPRESSUM) . '">' . MODULE_BOXES_INFORMATION_BOX_IMPRESSUM . '</a><br />' .
              '    <a href="' . tep_href_link(FILENAME_WIDERRUF) . '">' . MODULE_BOXES_INFORMATION_BOX_WIDERRUF . '</a><br />' .
