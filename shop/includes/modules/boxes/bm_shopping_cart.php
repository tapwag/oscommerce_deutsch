    ...
    function execute() {
      ...
      if ($cart->count_contents() > 0) {
        ...
        $cart_contents_string .= '<tr><td colspan="2" style="padding-top: 5px; padding-bottom: 2px;">' . tep_draw_separator() . '</td></tr>' .
                                 '<tr><td colspan="2" align="right">' . TEXT_BOX_CART_AMOUNT_NETTO . $currencies->format($cart->show_netto()) . '</td></tr>' .
                                 '<tr><td colspan="2" align="right">' . TEXT_BOX_CART_AMOUNT_MWST . $currencies->format($cart->show_total() - $cart->show_netto()) . '</td></tr>' .
                                 '<tr><td colspan="2" align="right">' . TEXT_BOX_CART_AMOUNT_TOTAL . $currencies->format($cart->show_total()) . '</td></tr>' .
