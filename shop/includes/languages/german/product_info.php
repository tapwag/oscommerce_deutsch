...
define('TEXT_PRODUCT_OPTIONS', 'Verf&uuml;gbare Optionen:');
define('TEXT_CLICK_TO_ENLARGE', 'F&uuml;r eine gr&ouml;ssere Darstellung<br>klicken Sie auf das Bild.');
// EU-NEUE
define('TEXT_LIEFERUNG', 'Lieferung bei heutiger Zahlung und innerhalb &Ouml;sterreichs '); // Hier das Land eingeben, das angegeben werden soll, in der Produktinformation.
//osc-support-edition BOF
define('TEXT_BASEPRICE', 'Grundpreis: ');
?>
