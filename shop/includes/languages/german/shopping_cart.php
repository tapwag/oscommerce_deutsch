...
define('SUB_TITLE_SUB_NETTO', 'Netto Warenwert: ');
define('SUB_TITLE_SUB_NETTO_AMOUNT', 'Summe Steuern: ');
define('TEXT_BASE_PRICE', '<small><i>(Grundpreis: %s | %s)</i></small>');
// osc-support-edition EOF
// define('OUT_OF_STOCK_CANT_CHECKOUT', 'Die mit ' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' markierten Produkte, sind leider nicht in der von Ihnen gew&uuml;nschten Menge auf Lager.<br>/>Bitte reduzieren Sie Ihre Bestellmenge f&uuml;r die gekennzeichneten Produkte, (' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . '),Vielen Dank');
