...
define('ERROR_PRICE_TO_LESS_THAN_PRICE_FROM','Preis bis muss gr&ouml;&szlig;er oder gleich Preis ab sein.');
define('ERROR_INVALID_KEYWORDS', 'Suchbegriff unzul&auml;ssig');

define('JS_ERROR_AT_LEAST_ONE_INPUT', 'Wenigstens ein Feld des Suchformulars muss ausge%FCllt werden.');
define('JS_ERROR_INVALID_FROM_DATE', 'Unzul%E4ssiges von Datum');
define('JS_ERROR_INVALID_TO_DATE', 'Unzul%E4ssiges bis jetzt Datum');
define('JS_ERROR_TO_DATE_LESS_THAN_FROM_DATE', 'Das Datum von muss gr%F6%DFer oder gleich dem bis jetzt Datum sein');
define('JS_ERROR_PRICE_FROM_MUST_BE_NUM', 'Preis ab muss eine Zahl sein');
define('JS_ERROR_PRICE_TO_MUST_BE_NUM', 'Preis bis muss eine Zahl sein');
define('JS_ERROR_PRICE_TO_LESS_THAN_PRICE_FROM','Preis bis muss gr%F6%DFer oder gleich Preis ab sein.');
define('JS_ERROR_INVALID_KEYWORDS', 'Suchbegriff unzul%E4ssig');
?>
