...
*/
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_CC_AIM_CREDIT_CARD_CVC', 'Pr&uuml;fnummer (CVC):');
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_CC_AIM_ERROR_TITLE', 'Ein Fehler ist bei der Pr&uuml;fung Ihrer Kreditkarte aufgetreten');
