...
define('HEADING_PRIVACY_INFORMATION', 'Privacy Policy');
define('PRIVACY_ACCEPT_TEXT', '<b>The privacy regulations, I have read!</b>');
define('HEADER_ERROR_ACCEPT_PRIVACY', 'Please accept the privacy policy!');
