...
define('TEXT_TAX_INFO', ' incl. %s Tax plus <a href="' . tep_href_link(FILENAME_POPUP_SHIPPING) . '" target="_blank" onclick="$(\'#popupShipping\').dialog(\'open\'); return false;"><u>shipping</u></a>');
define('TEXT_BOX_CART_AMOUNT_NETTO', 'Net Value: ');
define('TEXT_BOX_CART_AMOUNT_MWST', '+ VAT: ');
define('TEXT_BOX_CART_AMOUNT_TOTAL', 'Total: ');

define('HEADING_POPUP_SHIPPING', 'Shipping costs');
define('TEXT_POPUP_SHIPPING', 'Enter your shipping information.');

define('MODULE_BOXES_INFORMATION_BOX_IMPRESSUM', 'Imprint');
define('MODULE_BOXES_INFORMATION_BOX_WIDERRUF', 'Right of withdrawal');

define('HEADER_ERROR_ACCEPT_TERMS', 'Please accept the terms and conditions!');

define('TEXT_ACCOUNT_DELETED', 'Your account has been deleted successfully.');
