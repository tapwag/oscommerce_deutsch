...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr class="headerBar">
    ...
    <td class="headerBarContent" align="right"><?php echo (tep_session_is_registered('admin') ? 'Angemeldet als: ' . $admin['username']  . ' (<a href="' . tep_href_link(FILENAME_LOGIN, 'action=logoff') . '" class="headerLink">Abmelden</a>)' : ''); ?>&nbsp;&nbsp;</td>
  </tr>
</table>