...
define('TEXT_PRODUCTS_BASEPRICE_NET', 'Base price (net): ');
define('TEXT_PRODUCTS_BASEPRICE_GROSS', 'Base price (gross): ');
define('TEXT_PRODUCTS_BASEPRICE_UNIT', 'Base price Unit:');
